...
<div class="welcome">
    <div class="welcome-title">
        欢迎光临
        <div class="sub" id="message">点击开门按钮开启门禁</div>
    </div>
    <div class="btns">
        <a onClick="inShop()" class="btn-open" id="step-1"> <i class="icon icon-open"></i></a>
...
<script>
    ...
    function inShop() {
        $.post('${ctx}/wechat/shop/visit?flag=true', {}, function (data) {
            if (data.code == 0) {
                if (data.data == 1) {
                    if (handle) {
